const Ziggy = {
    ...
    routes: {
        ...
        "admin.users.temporary-permissions.store": {
            uri: "admin\/users\/{user}\/temporary-permissions",
            methods: ["POST"],
            parameters: ["user"],
            bindings: { user: "id" },
        },
        "admin.users.temporary-permissions.destroy": {
            uri: "admin\/users\/{user}\/temporary-permissions\/{temporaryPermission}",
            methods: ["DELETE"],
            parameters: ["user", "temporaryPermission"],
            bindings: { user: "id", temporaryPermission: "id" },
        },
        "admin.users.discounts.store": {
            uri: "admin\/users\/{user}\/discounts",
            methods: ["POST"],
            parameters: ["user"],
            bindings: { user: "id" },
        },
        "admin.users.discounts.update": {
            uri: "admin\/users\/{user}\/discounts\/{discount}",
            methods: ["PUT"],
        ...
        "admin.products.ingredients.store": {
            uri: "admin\/products\/{product}\/ingredients",
            methods: ["POST"],
            parameters: ["product"],
            bindings: { product: "id" },
        },
        "admin.products.ingredients.update": {
            uri: "admin\/products\/{product}\/ingredients\/{productIngredient}",
            methods: ["PUT"],
            parameters: ["product", "productIngredient"],
            bindings: { product: "id", productIngredient: "id" },
        },
        ...
        "admin.products.recipe-steps.store": {
            uri: "admin\/products\/{product}\/recipe-steps",
            methods: ["POST"],
            parameters: ["product"],
            bindings: { product: "id" },
        },
        "admin.products.recipe-steps.update": {
            uri: "admin\/products\/{product}\/recipe-steps\/{recipeStep}",
            methods: ["PUT"],
        ...
        "admin.weekly-menus.inline.update": {
            ...
            methods: ["PATCH"],
            parameters: ["weeklyMenu"],
            bindings: { weeklyMenu: "id" },
        },
        "admin.weekly-menus.update": {
            uri: "admin\/weekly-menus\/{weeklyMenu}",
            methods: ["PUT"],
            parameters: ["weeklyMenu"],
            bindings: { weeklyMenu: "id" },
        },
        ...
        "admin.weekly-menus.publish": {
            uri: "admin\/weekly-menus\/{weeklyMenu}\/publish",
            methods: ["POST"],
            parameters: ["weeklyMenu"],
            bindings: { weeklyMenu: "id" },
        },
        "admin.weekly-menus.unpublish": {
            uri: "admin\/weekly-menus\/{weeklyMenu}\/unpublish",
            methods: ["POST"],
            parameters: ["weeklyMenu"],
            bindings: { weeklyMenu: "id" },
        },
        "admin.weekly-menus.items.store": {
            uri: "admin\/weekly-menus\/{weeklyMenu}\/items",
            methods: ["POST"],
            parameters: ["weeklyMenu"],
            bindings: { weeklyMenu: "id" },
        },
        "admin.weekly-menus.items.update": {
            uri: "admin\/weekly-menus\/{weeklyMenu}\/items\/{item}",
            methods: ["PUT"],
            parameters: ["weeklyMenu", "item"],
            bindings: { weeklyMenu: "id", item: "id" },
        },
        "admin.weekly-menus.items.destroy": {
            uri: "admin\/weekly-menus\/{weeklyMenu}\/items\/{item}",
            methods: ["DELETE"],
            parameters: ["weeklyMenu", "item"],
            bindings: { weeklyMenu: "id", item: "id" },
        ...
        "admin.ingredient-supplier-terms.update": {
            uri: "admin\/ingredient-supplier-terms\/{ingredientSupplierTerm}",
            methods: ["PUT"],
            parameters: ["ingredientSupplierTerm"],
            bindings: { ingredientSupplierTerm: "id" },
        },
        ...
        "admin.purchases.store": { uri: "admin\/purchases", methods: ["POST"] },
        ...
        "admin.purchases.post": {
            uri: "admin\/purchases\/{purchase}\/post",
            methods: ["POST"],
            parameters: ["purchase"],
            bindings: { purchase: "id" },
        },
        "admin.purchases.cancel": {
            uri: "admin\/purchases\/{purchase}\/cancel",
            methods: ["POST"],
            parameters: ["purchase"],
            bindings: { purchase: "id" },
        },
        ...
        "admin.stock-counts.close": {
            uri: "admin\/stock-counts\/{stockCount}\/close",
            methods: ["POST"],
            parameters: ["stockCount"],
            bindings: { stockCount: "id" },
        },
