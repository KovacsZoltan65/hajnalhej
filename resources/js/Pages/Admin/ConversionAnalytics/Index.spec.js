...
const translations = {
    ...
    "conversion_analytics.description":
        "Conversion rates, time-series trends, hero variant comparison and funnel drop-off points.",
        ...
        const wrapper = mount(IndexPage, {
            ...
            props: {
                ...
                analytics: {
                    ...
                    top_product_revenue: [{ product_name: "Kovászos cipó", revenue: 12000, quantity: 4, orders: 2 }],
                    trend: {
                        points: [
                            {
                                date: "2026-04-23",
