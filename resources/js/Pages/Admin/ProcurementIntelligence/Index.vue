...
const generatePurchaseDrafts = () => {
    ...
    router.post(
        route("admin.procurement-intelligence.purchase-drafts.store"),
        {
...
<template>
    ...
    <section class="space-y-6">
        ...
        <IngredientCostTrendTable
            :rows="dashboard.ingredient_cost_trends"
            :recent-purchases="dashboard.recent_purchases"
        />
