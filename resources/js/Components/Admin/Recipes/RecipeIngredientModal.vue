...
<template>
    <Dialog
        :visible="visible"
        modal
        :header="item ? 'Hozzavalo szerkesztese' : 'Uj hozzavalo'"
        :style="{ width: '44rem', maxWidth: '97vw' }"
        :content-style="{ maxHeight: '70vh', overflowY: 'auto' }"
        @update:visible="(value) => emit('update:visible', value)"
    >
        <form id="recipe-ingredient-form" class="grid gap-3 rounded-2xl border border-bakery-brown/15 bg-white/85 p-4 md:grid-cols-4" @submit.prevent="submit">
