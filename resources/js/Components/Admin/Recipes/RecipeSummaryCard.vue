...
<template>
    <section class="grid gap-3 sm:grid-cols-2 xl:grid-cols-7">
        <article
            class="rounded-2xl border border-bakery-brown/10 bg-white/80 p-4 shadow-sm"
        >
        ...
        <article class="rounded-2xl border border-amber-200 bg-amber-50/70 p-4 shadow-sm">
            <p class="text-xs uppercase tracking-[0.14em] text-amber-700">
        ...
        >
            ...
            <p class="mt-2 font-heading text-2xl text-bakery-dark">
                {{ summary.total_recipe_minutes }} p
            </p>
        </article>
    </section>
</template>
