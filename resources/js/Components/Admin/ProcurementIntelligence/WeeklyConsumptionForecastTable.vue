            ...
            <table class="min-w-[760px] w-full text-sm">
                ...
                >
                    <tr>
                        ...
                        <th class="px-2 py-2 text-right">
                            {{ trans("admin_procurement_intelligence.columns.four_week_average") }}
                        </th>
                        <th class="px-2 py-2 text-right">
                            {{ trans("admin_procurement_intelligence.columns.next_week_forecast") }}
                        </th>
                        <th class="px-2 py-2 text-right">
                            {{ trans("admin_procurement_intelligence.columns.coverage_days") }}
                        </th>
                    </tr>
                </thead>
                <tbody>
                    <tr v-for="row in rows" :key="row.ingredient_id" class="border-b border-bakery-brown/10">
                        ...
                        <td class="px-2 py-3 text-right text-bakery-dark">
                            {{ row.last_week_consumption }} {{ row.unit }}
                        </td>
                        <td class="px-2 py-3 text-right text-bakery-dark">
                            {{ row.four_week_average }} {{ row.unit }}
                        </td>
                        <td class="px-2 py-3 text-right font-semibold text-bakery-dark">
                            {{ row.next_week_forecast }} {{ row.unit }}
                        </td>
