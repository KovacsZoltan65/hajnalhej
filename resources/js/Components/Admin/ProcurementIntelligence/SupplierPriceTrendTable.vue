            ...
            <table class="min-w-245 w-full text-sm">
                ...
                >
                    <tr>
                        ...
                        <th class="px-2 py-2 text-right">
                            {{ trans("admin_procurement_intelligence.columns.previous_price") }}
                        </th>
                        <th class="px-2 py-2 text-right">
                            {{ trans("admin_procurement_intelligence.columns.change") }}
                        </th>
                        <th class="px-2 py-2 text-right">
                            {{ trans("admin_procurement_intelligence.columns.change_percent") }}
                        </th>
                        <th class="px-2 py-2">
                            {{ trans("admin_procurement_intelligence.columns.cheapest") }}
                        </th>
                        <th class="px-2 py-2">
                            {{ trans("admin_procurement_intelligence.columns.most_expensive") }}
                        </th>
                        <th class="px-2 py-2">
                ...
                <tbody>
                    ...
                    >
                        ...
                        <td
                            ...
                            :class="row.change_percent >= 10 ? 'text-red-700' : 'text-bakery-dark'"
                        >
