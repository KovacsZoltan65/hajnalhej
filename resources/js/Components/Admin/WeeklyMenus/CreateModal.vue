...
<template>
    ...
    >
        <form id="weekly-menu-create-form" class="space-y-4" @submit.prevent="emit('submit')">
        ...
        <template #footer>
            <div class="flex justify-end gap-2">
                ...
                <Button type="submit" form="weekly-menu-create-form" label="Létrehozás" :loading="form.processing" />
            </div>
        </template>
    </Dialog>
</template>
