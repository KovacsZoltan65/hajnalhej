...
class WeeklyMenuListItemData extends Data
{
    /**
    ...
    public static function fromModel(WeeklyMenu $menu): self
    {
        ...
        return new self(
            ...
            items_count: (int) ($menu->items_count ?? $menu->items->count()),
            items: $menu->items
                ->map(fn (WeeklyMenuItem $item): array => WeeklyMenuItemData::from($item)->toArray())
                ->values()
                ->all(),
        );
    }
