...
class BranchIndexData extends Data
{
    ...
    public static function fromArray(array $payload): self
    {
        return new self(
            ...
            type: self::allowedNullableString($payload['type'] ?? null, BranchType::values()),
            ...
            sort_field: self::allowedString(
                ...
                ['name', 'code', 'type', 'email', 'phone', 'address', 'active', 'updated_at'],
                'name',
            ),
