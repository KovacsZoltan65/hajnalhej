 ...
 * @property Carbon $target_at Teljesites celido (mikorra legyen kesz)
 ...
 * @property Carbon|null $planned_start_at Javasolt kezdes a celidohoz visszaszamolva
 ...
 * @property-read Collection<int, ProductionPlanStep> $steps
