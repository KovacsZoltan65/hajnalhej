...
class PermissionManagementService
{
    ...
    public function detail(string $permissionName): array
    {
        ...
        return [
            ...
            'description' => $definition['description'] ?? __('permissions.orphan.description'),
            'module' => $definition['module'] ?? __('permissions.modules.orphan_custom'),
    ...
    private function collectPermissionRows(): Collection
    {
        ...
        foreach ($dbPermissions as $name => $permission) {
            ...
            $rows->push([
                'name' => $name,
                'label' => $name,
                'description' => __('permissions.orphan.description'),
                'module' => __('permissions.modules.orphan_custom'),
                'dangerous' => false,
                'system' => false,
